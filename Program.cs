...
namespace Phaseproject
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            using (FileStream fs = new FileStream(@"C:\Users\Public\Phaseproject\Teacher.txt", FileMode.Open))
            ...
            {
                List<Teacher> listTeachers = new List<Teacher>();
                string teacherfile = "C:\\Users\\Public\\Phaseproject\\Teacher.txt";
                ...
                File.WriteAllLines(@"C:\Users\Public\Phaseproject\Teacher.txt", arr);
            ...
            static void create()
            {
                ...
                string UIClass = "";
                string UIsection = "";
                using (FileStream fs = new FileStream(@"C:\Users\Public\Phaseproject\Teacher.txt", FileMode.Append))
